...
function Purchases() {
  ...
  return (
    <div className="flex h-screen">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 bg-gray-400 p-5 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
      ...
      {/* Main Content */}
      <div
        className={`flex-1 p-8 bg-gray-300 transition-all duration-300 ${isSidebarOpen ? "ml-64" : "ml-0"
          } md:ml-64`}
      >
